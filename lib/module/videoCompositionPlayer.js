...
export const useVideoCompositionPlayer = ({
  ...
  useFrameCallback(() => {
    ...
    if (!drawWhenPaused && !framesExtractor.isPlaying && currentFrame.value !== null && framesVersion === lastDrawnFramesVersion.value && currentTime === lastDrawnTime.value && revision === lastDrawnRevision.value && drawerRevision.value === lastDrawnDrawerRevision.value && surfaceWidth.value === pixelWidth && surfaceHeight.value === pixelHeight) {
